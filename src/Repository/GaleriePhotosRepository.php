...
/**
 * @extends ServiceEntityRepository<GaleriePhotos>
 *
...
class GaleriePhotosRepository extends ServiceEntityRepository
{
    ...
    public function save(GaleriePhotos $entity, bool $flush = false): void
    {
    ...
    public function remove(GaleriePhotos $entity, bool $flush = false): void
    {
